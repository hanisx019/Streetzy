...
const Apparel = () => {
  return (
    <div>
        <div className='flex-col md:flex md:flex-row py-4 px-8 mt-[200px] h-[90vh] '>
            <div className='w-full md:w-1/2 flex flex-col justify-center items-start gap-4 px-12 rounded-t-4xl md:rounded-l-4xl md:rounded-t-none bg-black text-white'>
                ...
                <p className='text-sm -mt-2 md:mt-0'>Dicover high qualtiy, comfortable clothing that effortlessly blends fashion and<br/> function. Designed to make you look and feel great everyday</p>
        ...
        <div className='-mt-50 md:mt-30 flex-col md:flex md:flex-row justify-around items-center mb-16'>
