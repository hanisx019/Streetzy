...
const TopFooter = () => {
  ...
  <div className='flex w-full justify-evenly bg-white items-center p-10 flex-wrap border-t-2 border-gray-200 gap-9 md:gap-0'>
      ...
      <div className='mb-14 md:mb-0'>
        <h4 className='mb-2 md:mb-4 text-[18px] text-center md:text-left'>"https://res.cloudinary.com/dfwq8rih1/image/upload/New7_lu7vl0.jpg"sletter</h4>
        <p className='text-neutral-500 text-[15px] text-center md:text-left mb-2 md:mb-0'>Be the first to hear about "https://res.cloudinary.com/dfwq8rih1/image/upload/New7_lu7vl0.jpg" products,<br/> exclusive events, and online offers.</p><br className='hidden md:block'/>
